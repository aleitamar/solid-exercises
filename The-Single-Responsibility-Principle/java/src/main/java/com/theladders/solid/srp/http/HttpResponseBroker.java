...
{
  public void provideResponse(HttpResponse response,
  ...
  public void provideResponseWithList(HttpResponse response,
                                      Map<String, Object> model,
                                      ResponseStatus responseStatus,
                                      List<String> list)
  {
  ...
  private static void setResult(HttpResponse response,
                                Result result)
  {
